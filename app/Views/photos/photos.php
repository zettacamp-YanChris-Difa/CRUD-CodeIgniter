            ...
            <a href="#">
                <div class="photos__image-container">
                    ...
                    <div class="photos__image_details-container">
                        <div class="photos__image-name"><h3><?= $pics['title'] ?></h3></div>
                        <div class="photos__image-description"><p><?= $pics['description'] ?></p></div>
                        <div class="photos__image-price"><h3><?= $pics['price'] ?></h3></div>
                    </div>
                </div>
            </a>
        <?php endforeach; ?>
